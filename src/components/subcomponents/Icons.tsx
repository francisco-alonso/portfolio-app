...
export const SunIcon: React.FC = ({ className, ...rest }: IconProps) => (
    ...
    >
        ...
        <path
            ...
            opacity="0"
        >
            <SetElement attributeName="opacity" begin="0.5s" to="1" />
        </path>
        </g>
        ...
        >
        <SetElement attributeName="opacity" begin="0.5s" to="0" />
        <animate
            fill="freeze"
            attributeName="r"
            begin="0.1s"
...
export const MoonIcon = ({ className, ...rest }: IconProps) => (
    ...
    >
        ...
        <SetElement attributeName="opacity" begin="0.6s" to="0" />
        </g>
        ...
        opacity="0"
        >
        <SetElement attributeName="opacity" begin="0.6s" to="1" />
        <animate
            fill="freeze"
            attributeName="r"
            begin="0.6s"
